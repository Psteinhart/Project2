node('master'){
    ...
    stage('Deploy'){
        try{
           // bat '"C:\\Program Files (x86)\\IIS\\Microsoft Web Deploy V3\\msdeploy.exe" -verb:sync -source:iisApp="C:\\Program Files (x86)\\Jenkins\\workspace\\jenkinsops\\JenkinsMVC\\" -dest:iisApp="Default Web Site/jenkinsops" -p:computer= "ec2-34-207-249-238.compute-1.amazonaws.com"-p:username="Administrator" -p:password=  -enableRule:AppOffline'
